...
namespace pokerstove
{
    ...
    class PokerHandEvaluation
    {
       public:
        ...
        explicit PokerHandEvaluation(const PokerEvaluation& e1) : eval1(e1), eval2() {}

        PokerHandEvaluation(const PokerEvaluation& e1, const PokerEvaluation& e2) : eval1(e1), eval2(e2) {}
    ...
    inline double shares(const PokerHandEvaluation& hero, const PokerHandEvaluation& villain)
    {
